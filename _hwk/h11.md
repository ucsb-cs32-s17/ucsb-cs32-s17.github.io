...
4.(2 pts) Refer to the declaration of ListNode on pages 740 and 741. Can we still implement a linked-list if we declared the member variable 'link' of ListNode as a reference instead of a pointer? Explain why or why not? 
