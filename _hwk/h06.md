...
6.  (2 pts) C++ 11 offers a datatype named "uint16_t" that uses exactly 16 bits to represent any non-negative integer. Given the following declaration of the variable 'x', what is the largest value that can be stored in x?
<div style="margin-bottom:1em"></div>
